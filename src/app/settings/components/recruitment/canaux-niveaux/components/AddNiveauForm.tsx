...
interface AddNiveauFormProps {
    onAdd: (nom: string) => void;
}

export const AddNiveauForm: React.FC<AddNiveauFormProps> = ({ onAdd }) => {
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 animate-in slide-in-from-top-2 duration-300">
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="flex items-center justify-between">
                    <h3 className="text-lg font-medium text-gray-900">Nouveau niveau</h3>
                    <button
                        type="button"
                ...
                <div>
                    <label htmlFor="niveau-nom" className="block text-sm font-medium text-gray-700 mb-2">
                        Nom du niveau
                    </label>
                    <input
                        type="text"
                        ...
                        placeholder="Ex: Senior, Junior, Expert..."
                        required
                    />
                </div>
